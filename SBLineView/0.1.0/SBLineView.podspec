#
#  Be sure to run `pod spec lint SBLineView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.author             = { "Stefan Britton" => "stefan.britton@me.com" }
  s.author    = "Stefan"
  # s.authors            = { "Stefan Britton" => "stefan.britton@me.com" }
  # s.social_media_url   = "http://twitter.com/Stefan Britton"
